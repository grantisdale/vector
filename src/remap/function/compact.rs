...
mod test {
    ...
    fn test_compacted_array() {
        let cases = vec![
            (
                vec![Value::from(1), Value::from(2)],              // expected
                vec![Value::from(1), Value::Null, Value::from(2)], // original
                CompactOptions {
                    null: true,
                    ..Default::default()
                },
            ...
            (
                ...
                vec![Value::from(1), Value::Array(vec![]), Value::from(2)],
                CompactOptions {
                    array: true,
                    ..Default::default()
                },
            ...
            (
                ...
                vec![
                    Value::from(1),
                    Value::Array(vec![Value::Null, Value::from(3), Value::Null]),
                    Value::from(2),
                ],
                CompactOptions {
                    recursive: true,
        ...
        let cases = vec![
            (
                map!["key1": Value::from(1),
                     "key3": Value::from(2)], // expected
                map!["key1": Value::from(1),
                     "key2": Value::Null,
                     "key3": Value::from(2)], // original
                CompactOptions {
                    null: true,
                    ..Default::default()
                },
            ...
            (
                map!["key1": Value::from(1),
                     "key2": Value::Array(vec![Value::from(2)]),
                     "key3": Value::from(2),
                ],
                map![
                    "key1": Value::from(1),
                    "key2": Value::Array(vec![Value::Null, Value::from(2), Value::Null]),
                    "key3": Value::from(2),
                ],
                CompactOptions {
                    recursive: true,
        ...
        let cases = vec![
            (
                ...
                CompactFn::new(
                    ...
                    Some(Box::new(Literal::from(true))),
                    Some(Box::new(Literal::from(true))),
                    Some(Box::new(Literal::from(true))),
                    Some(Box::new(Literal::from(true))),
                    Some(Box::new(Literal::from(true))),
